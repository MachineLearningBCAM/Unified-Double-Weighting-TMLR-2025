function Experiments_20News_multiclass(idx1)
...
[xTrain, yTrain, xTest, yTest] = generate_source_multiclass(idx1);

top_features = PCC([cell2mat(xTrain); cell2mat(xTest)], [cell2mat(yTrain); cell2mat(yTest)], 3000);
